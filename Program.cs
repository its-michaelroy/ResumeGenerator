                            ...
                            .Column(column =>
                            {
                                ...
                                column.Item().PaddingVertical(3).Column(section =>
                                {
                                    ...
                                    section.Item().PaddingTop(5).Column(exp =>
                                    {
                                        ...
                                        exp.Item().PaddingVertical(5).Column(job =>
                                        {
                                            job.Item().Row(row =>
                                            {
                                                row.RelativeItem()
                                        ...
                                        // Network Specialist Intern | YMCA
                                        exp.Item().PaddingVertical(5).Column(job =>
                                        {
                                            job.Item().Row(row =>
                                            {
                                                row.RelativeItem().Text("Network Specialist Intern | YMCA")
                                                    .Bold();
                                            ...
                                            job.Item().Row(row =>
                                            {
                                                ...
                                                row.ConstantItem(11).Text("•").FontSize(14);
                                                row.RelativeItem().Text(
                                                    "Upgraded Windows Hypervisor Server and virtual machines, replaced Sophos Firewall, and installed new access points, enhancing network performance and security for 50+ users");
                                            });
                                            job.Item().Row(row =>
                                            {
                                                row.ConstantItem(20);
                                                row.ConstantItem(11).Text("•").FontSize(14);
                                                row.RelativeItem().Text(
                                                    "Maintained Active Directory by managing user accounts, writing scripts to automate logging of new users and computers, and configuring local policies, improving onboarding efficiency by 30%");
                                            });
                                            job.Item().Row(row =>
                                            {
                                                row.ConstantItem(20);
                                                row.ConstantItem(11).Text("•").FontSize(14);
                                                row.RelativeItem().Text(
                                                    "Created connection to CCTV cameras with remote access by configuring firewall port forwards, replaced 20+ desktop machines, and installed antivirus software, ensuring operational continuity and security compliance");
                                            });
                                        });
                                        exp.Item().Height(1); // Adds 1 points of empty space
