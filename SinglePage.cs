...
namespace ResumeGenerator
{
    class SinglePage
    {
        public static void RunSinglePage(string[] args)
        {
            ...
            try
            {
                ...
                string outputPath = Path.Combine(projectRoot, "Resumes", "Michael_Roy_Software_Engineer-1pg.pdf");
                        ...
                        container.Page(page =>
                        {
                            ...
                            page.Content()
                                ...
                                .Column(column =>
                                {
                                    ...
                                    column.Item().PaddingTop(43).Column(skills =>
                                    {
                                        skills.Spacing(3);
                                        skills.Item().Row(row =>
                                        {
                                    ...
                                    column.Item().PaddingTop(2).Column(proj =>
                                    {
                                        proj.Spacing(3);
                                        ...
                                        proj.Item().Row(row =>
                                        {
                                            row.RelativeItem().Text(t =>
                                            {
                                                ...
                                                t.Span("deep-impact.onrender.com ").FontColor(Colors.DeepPurple.Accent4)
                                                    .Bold();
                                    ...
                                    // Education
                                    column.Item().PaddingTop(0.5f); // Space before the new section
                                    column.Item().Text("EDUCATION").FontSize(14).Bold();
                                    column.Item().LineHorizontal(1).LineColor(Colors.Black); // Section break underline
                                    column.Item().PaddingTop(2).Column(edu =>
                                    {
                                        edu.Spacing(3);
                                        edu.Item().Row(row =>
                                        {
                                    ...
                                    column.Item().LineHorizontal(1).LineColor(Colors.Black); // Section break underline
                                    column.Item().PaddingTop(2).Column(exp =>
                                    {
                                        exp.Spacing(3);
                                        exp.Item().Row(row =>
                                        {
                                            row.RelativeItem().Text("Software Engineering Fellow | Headstarter AI")
                                                .Bold();
                                        ...
                                        {
                                            row.RelativeItem()
                                                .Text("Information Technology Specialist - Tier 3 | TEKSystems").Bold();
                                        ...
                                        exp.Item().Row(row =>
                                        {
                                            row.RelativeItem().Text("Systems Analyst - Tier 3 | Arnett Carbis Toothman")
                                                .Bold();
